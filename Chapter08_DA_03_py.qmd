...
```{python}
#| label: update_install_kears3_and_jax
#| message: false
#| include: false
...
```{python}
#| label: Compile_and_Fit_MLP_model
batch_size = 128
...
```{python}
#| label: Display_learning_process_of_MLP_model
