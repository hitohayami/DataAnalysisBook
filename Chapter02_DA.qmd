...
plot(x,y,xlim=c(0,1),ylim=c(0,1),cex=0.01,family=Kanji)
...
# plot(Month_cpi,dlnCPI,type="l",xlab="",ylab="%",sub="総合CPI変化率(対前年比)",family=Kanji)
plot(Month_cpi,dlnCPI,type="l",xlab="",ylab="%")
...
plot(Month_lfs,lfs_data$UR,type="l",sub="完全失業率",ylab="%",xlab="",family = "HiraKakuProN-W3")
...
# plot(UR[d_lfs:(n_lfs+e_lfs)],dlnCPI[d_cpi:(n_cpi+e_cpi)],cex=0.2,sub="Phillips Relations",xlab="失業率",ylab="インフレ率",family=Kanji)
plot(UR[d_lfs:(n_lfs+e_lfs)],dlnCPI[d_cpi:(n_cpi+e_cpi)],cex=0.2,xlab="失業率",ylab="インフレ率")
```
